...
class SettingsProvider extends ChangeNotifier {
  ...
  static const _labelsId = <String, String>{
    ...
    'theme':              'Tema',
    'language':           'Bahasa',
    // Support / Premium IAP (Bulan 3 monetization)
    'support':              'Dukungan',
    'supportTitle':         'Hilangkan Iklan',
    'supportSubtitle':      'Dukung pengembangan Waktu Shalat',
    'supportHeroTitle':     'Bebas Iklan Selamanya',
    'supportHeroSubtitle':  'Dukung pengembangan independen Waktu Shalat dengan pembelian satu kali.',
    'supportBenefit1':      'Bebas iklan selamanya',
    'supportBenefit2':      'Dukung pengembang independen',
    'supportBenefit3':      'Pembayaran satu kali',
    'supportBenefit4':      'Tanpa langganan',
    'supportButton':        'Dukung',
    'supportLoading':       'Memproses...',
    'supportRestore':       'Pulihkan Pembelian',
    'supportFooter':        'Pembayaran satu kali via Google Play. Tidak ada langganan tersembunyi.',
    'supportThanksTitle':   'Jazākallāhu khayrān!',
    'supportThanksMessage': 'Bebas iklan aktif selamanya. Terima kasih atas dukungan Anda untuk pengembangan Waktu Shalat.',
    'supportStatusActive':  'Status Pendukung',
    'supportPurchaseFailed':'Pembelian gagal. Silakan coba lagi.',
    'supportPurchaseSuccess':'Terima kasih atas dukungan Anda!',
    'supportRestoreSuccess':'Pembelian Anda berhasil dipulihkan.',
    'supportRestoreNothing':'Tidak ada pembelian sebelumnya untuk dipulihkan.',
    'supportProductUnavailable':'Produk tidak tersedia. Pastikan Anda terhubung ke internet dan akun Google Play aktif.',
    'about':              'Tentang',
    'version':            'Versi',
  ...
  static const _labelsEn = <String, String>{
    ...
    // Support / Premium IAP (Bulan 3 monetization)
    'support':              'Support',
    'supportTitle':         'Remove Ads',
    'supportSubtitle':      'Support Waktu Shalat development',
    'supportHeroTitle':     'Ad-Free Forever',
    'supportHeroSubtitle':  'Support independent development of Waktu Shalat with a one-time purchase.',
    'supportBenefit1':      'Ad-free forever',
    'supportBenefit2':      'Support independent developer',
    'supportBenefit3':      'One-time payment',
    'supportBenefit4':      'No subscription',
    'supportButton':        'Support',
    'supportLoading':       'Processing...',
    'supportRestore':       'Restore Purchase',
    'supportFooter':        'One-time payment via Google Play. No hidden subscriptions.',
    'supportThanksTitle':   'Jazākallāhu khayrān!',
    'supportThanksMessage': 'Ad-free is active forever. Thank you for supporting Waktu Shalat development.',
    'supportStatusActive':  'Supporter Status',
    'supportPurchaseFailed':'Purchase failed. Please try again.',
    'supportPurchaseSuccess':'Thank you for your support!',
    'supportRestoreSuccess':'Your purchase has been restored.',
    'supportRestoreNothing':'No previous purchase found to restore.',
    'supportProductUnavailable':'Product unavailable. Make sure you have internet connection and active Google Play account.',
    'about':              'About',
    'version':            'Version',
  ...
  static const _labelsAr = <String, String>{
    ...
    // Support / Premium IAP (Bulan 3 monetization)
    'support':              'الدعم',
    'supportTitle':         'إزالة الإعلانات',
    'supportSubtitle':      'ادعم تطوير وقت الصلاة',
    'supportHeroTitle':     'بلا إعلانات إلى الأبد',
    'supportHeroSubtitle':  'ادعم التطوير المستقل لتطبيق وقت الصلاة بدفعة واحدة.',
    'supportBenefit1':      'بلا إعلانات إلى الأبد',
    'supportBenefit2':      'دعم مطور مستقل',
    'supportBenefit3':      'دفعة واحدة',
    'supportBenefit4':      'بدون اشتراك',
    'supportButton':        'ادعم',
    'supportLoading':       'جارٍ المعالجة...',
    'supportRestore':       'استعادة الشراء',
    'supportFooter':        'دفعة واحدة عبر Google Play. لا اشتراكات مخفية.',
    'supportThanksTitle':   'جزاك الله خيراً!',
    'supportThanksMessage': 'تفعّل وضع بلا إعلانات إلى الأبد. شكراً لدعمك تطوير وقت الصلاة.',
    'supportStatusActive':  'حالة الداعم',
    'supportPurchaseFailed':'فشلت عملية الشراء. حاول مرة أخرى.',
    'supportPurchaseSuccess':'شكراً لدعمك!',
    'supportRestoreSuccess':'تم استعادة عملية الشراء.',
    'supportRestoreNothing':'لم يتم العثور على مشتريات سابقة لاستعادتها.',
    'supportProductUnavailable':'المنتج غير متوفر. تأكد من اتصالك بالإنترنت وحساب Google Play نشط.',
    'about':              'عن التطبيق',
    'version':            'الإصدار',
    'developedBy':        'تطوير',
